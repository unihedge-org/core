...
contract MarketFactory_2 {

    IUniswapV2Factory public uniswapFactory;
    mapping(address => Market_2) public markets;
    ...
    function addMarket(address _token, address _uniswapPair, uint _period, uint _initTimestamp, uint _settlementInterval, uint _minHorizon, uint _maxHorizon, uint _fee) external {
        Market_2 market = new Market_2(this, IERC20(_token), IUniswapV2Pair(_uniswapPair), _period, _initTimestamp, _settlementInterval, _minHorizon, _maxHorizon, _fee);
