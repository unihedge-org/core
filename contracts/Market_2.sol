...
//This market contract is for testing purposes only! 
//TODO: Pri average price spremeni. Oz naredi v testih take funkcije kot tukaj not!!!
...
contract Market_2 {
    ...
    //Set frame prices
    function updateFramePrices(uint PriceCumulative, uint timestamp) public {
    ...
    function closeFrame(uint frameKey) public returns (SFrame){
        ...
        frames[frameKey].priceAverage = dP/dT;
