...
*/
describe('Get users lots sold', function () {
  let accounts, owner, user, token, wPOLContract, contractMarket, frameKey, dPrice, acqPrice, tax, tokenDecimals;
  ...
  it('Third user buys lot', async function () {
    ...
    await contractMarket
      .connect(user3)
      .tradeLot(frameKey, pairPrice2, acqPrice2, { maxFeePerGas: ethers.BigNumber.from(Math.floor(1.25 * block.baseFeePerGas)) });
