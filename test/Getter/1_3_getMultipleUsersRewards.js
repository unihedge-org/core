...
*/
describe("Get multiple users comulative awards", function () {
    ...
    it('Calculate users reward fund', async function () {
        ...
        let rewards = await contractMarketGetter.getMultipleUsersRewards(contractMarket.address, 0, 5, frameKeyStart, frameKeyEnd);
        console.log("\x1b[33m%s\x1b[0m", "   Reward fund: ", ethers.utils.formatUnits(rewards[0], 18), " DAI");
    });
})
