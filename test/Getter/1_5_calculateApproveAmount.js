...
describe('Purchase one random empty lot', function () {
  ...
  it('Deploy Market anmd Getter contract', async function () {
  ...
  it('Approve USDC to spend and Purchase Lot', async function () {
    ...
    const taxQ96 = await contractMarketGetter.clcAmountToApprove(contractMarket.address, frameKey, rateAtStart, acqPriceQ96);
